...
async function isFavorite(noticiaId) {
  ...
  try {
    const res = await fetch(`${API_BASE}favoritos?usuarioId=${CURRENT_USER_ID}&noticiaId=${noticiaId}`);
                ...
                <div class="news-card fade-in">
                    ...
                    <div class="news-content">
                        ...
                        <div class="news-actions">
                            ...
                            <button onclick="toggleFavorite('${noticia.id}')" class="btn-icon btn-fav ${favs[i] ? 'active' : ''}">
                                <i class="bi ${favs[i] ? 'bi-heart-fill' : 'bi-heart'}"></i>
                            </button>
                            ${isAdmin() ? `
                                <a href="gerenciar-noticia.html?id=${noticia.id}" class="btn-icon btn-edit" title="Editar">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <button onclick="excluirNoticia('${noticia.id}')" class="btn-icon btn-delete" title="Excluir">
